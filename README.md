...
Machine Learning & Data Science enthusiast focused on building practical ML and LLM-based systems. Passionate about model optimization, RAG architectures, and scalable AI applications.

Currently building real-world ML systems instead of just training models on toy datasets.

- 🌱 **Currently Exploring:** LLM Fine-Tuning, RAG Architectures, AI Agents  
- 👯 **Open to Collaborate On:** ML Projects & LLM Applications  
- 💬 **Ask Me About:** Machine Learning, Python, Model Optimization  
- 📫 **Reach Me At:** varshithr452@gmail.com  
- 😄 **Pronouns:** He/Him  
